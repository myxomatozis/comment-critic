...
# A bare "DO NOT EDIT" is a human warning, not a generator's disclaimer.
warned = pathlib.Path(sandbox2) / "careful.go"
warned.write_text("// DO NOT EDIT without updating the schema first.\n" + block_for("x.go") + "\n")
code, _ = run({"tool_name": "Write", "cwd": sandbox2,
               "tool_input": {"file_path": "careful.go", "content": block_for("x.go")}})
assert code == 2, "a bare DO NOT EDIT must not disarm the hook"
