...
disowns its output in the file's head, and that does. The first 40 lines are checked for
`@generated`, `<auto-generated>`, `auto-generated`, `automatically generated`, `code generated
by`, `generated code - do not`, or protobuf's own banner. That covers protoc, Dart's build_runner,
.NET designers, Thrift, SWIG and the Meta convention.
...
A bare `DO NOT EDIT` is **not** enough: hand-written files use it to warn a human, and the
standard generator phrasings above are specific enough not to need it.
